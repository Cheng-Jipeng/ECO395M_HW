...
bad flights, Figure @ref(fig:fig2) shows the proportions of all kinds of
flights’ states. If *minor delays can annoy you very much too*, then you
must avoid choosing **Atlanta airport** as your destination among the
top 10 worst airports.

<div class="figure" style="text-align: center">

<img src="Exercise_1_files/figure-markdown_github/fig2-1.png" alt="Distribution of Delays in Top 10 Worst Destination of 2008"  />
<p class="caption">
Distribution of Delays in Top 10 Worst Destination of 2008
</p>

</div>

Does the top list change over the months in 2008? Table @ref(tab:tab1)
answers the question in details by focusing on the top 5 worst airports
in each month. Definitely there are new blood across different months
like Boston airport in February, Ontario airport in April.
...
<caption>
Top 5 Worst Destinations across Months
</caption>
<thead>
<tr>
...
Figure @ref(fig:fig3). There are 23 airports in all of the monthly
lists, and this also support our conclusion from yearly list: all 12
lists contains EWR and 6 lists contains JFK.

<div class="figure" style="text-align: center">

<img src="Exercise_1_files/figure-markdown_github/fig3-1.png" alt="Frequency of Appearances in Top 5 Worst Destinations across Months"  />
<p class="caption">
Frequency of Appearances in Top 5 Worst Destinations across Months
</p>
...
<img src="Exercise_1_files/figure-markdown_github/fig4-1.png" alt="Musical Diversity Over Time"  />
<p class="caption">
...
<img src="Exercise_1_files/figure-markdown_github/fig5-1.png" alt="Artists Having over 30 Ten-Week-Hits Songs"  />
<p class="caption">
Artists Having over 30 Ten-Week-Hits Songs
</p>
...
<img src="Exercise_1_files/figure-markdown_github/unnamed-chunk-3-1.png" alt="Increasing Trend of Age Similar Across Female and Male Swimmers' Age After Female Participation in Olympics"  />
<p class="caption">
Increasing Trend of Age Similar Across Female and Male Swimmers’ Age
After Female Participation in Olympics
</p>
...
<img src="Exercise_1_files/figure-markdown_github/fig6-1.png" alt="RMSE vs. K"  />
<p class="caption">
RMSE vs. K
</p>
...
<img src="Exercise_1_files/figure-markdown_github/fig7-1.png" alt="Prediction vs. Testing Set"  />
<p class="caption">
Prediction vs. Testing Set
</p>
