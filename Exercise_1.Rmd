...
If you are also interested in if there are many minor delays in these bad flights, Figure 2 shows the proportions of all kinds of flights' states. If *minor delays can annoy you very much too*, then you must avoid choosing **Atlanta airport** as your destination among the top 10 worst airports.

```{r fig2, fig.align='center', fig.cap= "Figure 2: Distribution of Delays in Top 10 Worst Destination of 2008", echo = FALSE}
...
```{r, fig.align='center', fig.cap="Figure 4: Delay Rate by Month in 2008"}
abia_modified = abia %>%
...
```
## Part B
```{r fig4, fig.align='center', fig.cap= "Figure 5: Musical Diversity Over Time", echo = FALSE}
# Part B
billboard %>%
...
```
## Part C
```{r fig5, fig.align='center', fig.cap="Figure 6: Artists Having over 30 Ten-Week-Hits Songs", echo = FALSE}
# Part C
...
## Part C
```{r, fig.align='center', fig.cap="Figure 7: Increasing Trend of Age Similar Across Female and Male Swimmers' Age After Female Participation in Olympics", echo = FALSE}
# Part C
olympics_top20 %>%
...
# K-nearest neighbors
```{r fig6, fig.align='center', fig.cap="Figure 8: RMSE vs. K", echo = FALSE, warning  = FALSE}
...
```{r fig7, fig.align='center', fig.cap="Figure 9: Prediction vs. Testing Set", echo = FALSE}
