...
We can also visualize the top 10 airports on a U.S. map in Figure 2 with blue bars refering to the values of their "Bad Index".
...
knitr::kable(top_song_table, col.names = c("Performer","Song","Count"))
```
