...
```{r, fig.align='center', fig.cap="Delay Rate by Month in 2008"}
abia_modified = abia %>%
...
```
## Part B
```{r fig4, fig.align='center', fig.cap= "Figure 4: Musical Diversity Over Time", echo = FALSE}
# Part B
billboard %>%
...
```
## Part C
```{r fig5, fig.align='center', fig.cap="Figure 5: Artists Having over 30 Ten-Week-Hits Songs", echo = FALSE}
# Part C
...
## Part C
```{r, fig.align='center', fig.cap="Figure 6: Increasing Trend of Age Similar Across Female and Male Swimmers' Age After Female Participation in Olympics", echo = FALSE}
# Part C
olympics_top20 %>%
...
# K-nearest neighbors
```{r fig6, fig.align='center', fig.cap="Figure 7: RMSE vs. K", echo = FALSE, warning  = FALSE}
...
```{r fig7, fig.align='center', fig.cap="Figure 8: Prediction vs. Testing Set", echo = FALSE}
