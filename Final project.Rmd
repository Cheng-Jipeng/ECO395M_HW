...
```
\flushleft
Lesso approach is to make some regularization so that the regularized fit minimizes the deviance plus a **penalty** on the complexity of the estimate:$minimize_{\beta\in R} dev(\beta)/n+\lambda\times pen(\lambda)$ (2). 
